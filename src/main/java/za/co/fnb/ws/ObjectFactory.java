 ...
 * generated in the za.co.fnb.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _CalculateSum_QNAME = new QName("http://ws.fnb.co.za/", "calculateSum");
    private final static QName _CalculateSumResponse_QNAME = new QName("http://ws.fnb.co.za/", "calculateSumResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: za.co.fnb.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.fnb.co.za/", name = "calculateSum")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.fnb.co.za/", name = "calculateSumResponse")
